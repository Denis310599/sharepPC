...
#API
docker run -it -d -p 91:80 -e HOST_API="gusydenis.duckdns.org" -e PORT_API=91 -e HOST_WS="gusydenis.duckdns.org" -e PORT_WS=28000 -e HOST_TURN="gusydenis.duckdns.org" -e PORT_TURN=3478 -e USER_TURN="sharepc" -e PASS_TURN="sharepc1" --dns 8.8.8.8 --name share_api share_api
